  ...
  return (
    <div className="p-8 flex-1 overflow-auto bg-[#F5F5F7]">
      ...
      <div className="bg-white p-10 rounded-2xl shadow-[0_2px-10px_rgba(0,0,0,0.02)] border border-gray-100">
        <h2 className="text-2xl font-bold text-gray-900 mb-8 pb-4 border-b border-gray-100">編輯角色</h2>
        <p className="text-gray-500">編輯角色功能開發中...</p>
        <div className="flex gap-3 mt-8">
          <AppleButtonPrimary>確定</AppleButtonPrimary>
          <AppleButtonSecondary onClick={() => navigate('/roles')}>返回</AppleButtonSecondary>
        </div>
      </div>
    </div>
  );
